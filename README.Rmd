...
The goal of `erpcore` is to provide some simple command line functions for downloading the ERP CORE (Kappenman, Farrens, Zhang, Stewart, & Luck, 2020) datasets from the [Open Science Framework](https://osf.io/) website.
